...
class KycEntityRepo:
    ...
    def get_obj(self, session: AsyncSession, obj_id: UUID):
    ...
    def create_obj(self, session: AsyncSession, p_model: KycCreate) -> KycModel:
    ...
    def delete_obj(self, session: AsyncSession, obj_id: UUID) -> None:
