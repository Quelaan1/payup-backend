...
# def add_vehicle_txn(
#     session, city, owner_id, last_location, type, color, brand, status, is_owner
# ):
#     """
...
#         .filter(Vehicle.owner_id == owner, Vehicle.status != "removed")
#         .all()
#     )
#     if not vehicles:
...
#     """
#     users = (
#         session.query(User).filter(User.city == city, User.username is not None).all()
#     )
#     return list(
#         map(
#             lambda user: {
...
#     vehicles = (
#         session.query(Vehicle)
#         .filter(Vehicle.city == city, Vehicle.status != "removed")
#         .all()
#     )
#     return list(
#         map(
